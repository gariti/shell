...
ListView {
    ...
    readonly property string query: search.text.slice(LauncherConfig.actionPrefix.length + "scheme ".length)
    ...
    model: Schemes.fuzzyQuery(query)
    clip: true
    ...
    delegate: ItemDelegate {
        ...
        readonly property bool isCurrent: modelData.name === Schemes.current
        ...
        onClicked: {
            ...
            Schemes.setScheme(modelData.name);
        }
    }
}
